...
import model.Car;
import model.CarsRented;
import utils.ClearScreen;

public class CarsRentedView {
    private static boolean resume = true;
    private static CarsRented carsRented = new CarsRented();

    public static void run() throws IOException {

        System.out.println("Welcome to the Rented cars List!");
        ...
        while (resume) {
            ...
            case 1:
                ClearScreen.run();
                showTheList(carsRented.getList());
            ...
            case 3:
                ...
                carsRented.removeFromList(carsRented.getList().get(RemoveCarView.run()).getId());
                DataBaseController.saveToDatabase();
